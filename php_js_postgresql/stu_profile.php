...
if (isset($_SESSION["email"]))
 {
   ...
   { 
     ...
     <td style='border:3px solid white'><a href='user_display_events.php' class='btn' style='display: inline-block;padding:10px 30px;font-size: 20px;
     background: rgb(250, 171, 171);color:#fff;margin:0 5px;text-transform: capitalize;'>show events</a></td>

     <td style='border:3px solid white'><a href='my_events.php' class='btn' style='display: inline-block;padding:10px 30px;font-size: 20px;
     background: rgb(250, 171, 171);color:#fff;margin:0 5px;text-transform: capitalize;'>my events</a></td>
